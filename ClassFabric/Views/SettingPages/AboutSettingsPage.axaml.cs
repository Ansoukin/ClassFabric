...
public partial class AboutSettingsPage : SettingsPageBase
{
    ...
    public AboutSettingsPage()
    {
        DataContext = this;
        InitializeComponent();
        ViewModel.License = AssetLoader.ReadAllText(new Uri("avares://ClassFabric/Assets/LICENSE.txt"));

        var dependenciesJson = AssetLoader.ReadAllText(new Uri("avares://ClassFabric/Assets/dependencies.g.json"));
