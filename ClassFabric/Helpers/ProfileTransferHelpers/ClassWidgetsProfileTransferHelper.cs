...
{
    public static Profile ConvertClassWidgets1ProfileToClassFabricProfile(string path, Profile? profile = null)
    {
        var profileCw = ConfigureFileHelper.LoadConfigUnWrapped<CwProfile>(path);
        return ConvertClassWidgets1ProfileToClassFabricProfile(profileCw, profile);
    }

    public static Profile ConvertClassWidgets1ProfileToClassFabricProfile(Stream stream, Profile? profile = null)
    {
