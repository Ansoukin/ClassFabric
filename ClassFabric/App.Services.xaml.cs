...
public partial class App
{
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddProfileTransferProvider<ClassIsland1ImportProvider>("classfabric.profileTransfer.import.legacyV1", "从 ClassIsland 1.x 导入", ProfileTransferProviderType.Import, "bitmap(avares://ClassFabric/Assets/AppLogo.png)");
        ...
        services.AddProfileTransferProvider<ClassWidgets2ImportProvider>("classfabric.profileTransfer.import.classWidgets2", "从 Class Widgets 2 导入", ProfileTransferProviderType.Import);
