...
public sealed class ClassFabricDocumentsProvider : DocumentsProvider
{
    private const string RootId = "classfabric";
    ...
    private string RootPath
    {
        get
        {
            ...
            var rootPath = Path.Combine(filesPath, ".config", "ClassFabric");
    ...
    public override ICursor QueryRoots(string[]? projection)
    {
        ...
        foreach (var column in columns)
        {
            AddValue(row, column, column switch
            {
                ...
                DocumentsContract.Root.ColumnSummary => "ClassFabric data",
