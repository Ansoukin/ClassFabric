...
{
    internal static string LegacyAppRootFolderPath { get; } = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
        "ClassIsland",
        "Data");

    internal static string LegacyAppConfigPath { get; } = Path.Combine(LegacyAppRootFolderPath, "Config");
    ...
    public static string AppDataFolderPath =>
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "ClassFabric");
