...
// 引用 SimpleGitInfoGenerator 生成的 GitInfo 类
using ClassIsland;

namespace ClassFabric.Core;
...
public abstract class AppBase : Application, IAppHost
{
    ...
    public static string AppCodeName => "KapoKali";
    ...
    /// Fluent Icons 字体
    /// </summary>
    public static FontFamily FluentIconsFontFamily { get; } = new FontFamily("avares://ClassFabric.Core/Assets/Fonts/#FluentSystemIcons-Resizable");

    /// <summary>
    /// Lucide Icons 字体
    /// </summary>
    public static FontFamily LucideIconsFontFamily { get; } = new FontFamily("avares://ClassFabric.Core/Assets/Fonts/#lucide");
    
    /// <summary>
    /// SF Symbols 字体
    /// </summary>
    public static FontFamily SFSymbolsFontFamily { get; } = new FontFamily("avares://ClassFabric.Core/Assets/Fonts/#SF-Symbols");
