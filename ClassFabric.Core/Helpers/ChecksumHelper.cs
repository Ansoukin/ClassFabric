...
public static class ChecksumHelper
{
    ...
    /// 从发行日志中提取校验和。<br/>
    ///
    /// 可以被此方法提取的校验和信息字典（键为文件名，值为MD5校验和）包裹在以 CLASSFABRIC_PKG_MD5 开头的注释标签中，并以 json 格式存储，例如：<br/>
    /// 
    /// &lt;!-- CLASSFABRIC_PKG_MD5 {"ClassFabric.zip":"5D413B24956724B004B1069C0AA6B3DE"} --&gt;
    /// </summary>
    ...
    {
        var regex = new Regex(@"<!-- CLASSFABRIC_PKG_MD5 (.+?) -->");
